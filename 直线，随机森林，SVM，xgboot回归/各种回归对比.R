...
#ggplot2作图
lm_result <- data.frame(Actual=c(traindata$y,testdata$y),
...
lm_pe<- ggplot(lm_result,
       aes(x=Actual,y=Prediction,fill=group,colour=group))+
...
#ggplot2作图
rf_result <- data.frame(Actual=c(traindata$y,testdata$y),
...
#ggplot2作图
svm_result <- data.frame(Actual=c(traindata$y,testdata$y),
...
#ggplot2作图
xg_result <- data.frame(Actual=c(data_train$y,testdata$y),
